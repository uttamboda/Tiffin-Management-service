...
class UserServiceTest {
    ...
    void createUser_Success() {
        ...
        com.example.Tiffin_Management.entity.Shop mockShop = new com.example.Tiffin_Management.entity.Shop();
        mockShop.setId(1L);
    ...
    void getAllUsers_ReturnsList() {
        ...
        when(userRepository.findAllByShop_Id(eq(1L), eq(pageRequest))).thenReturn(userPage);
        ...
        verify(userRepository, times(1)).findAllByShop_Id(eq(1L), eq(pageRequest));
    }
}
